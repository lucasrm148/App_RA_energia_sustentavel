...
IL_0010:
	{
		...
		NullCheck(L_12);
		L_12->___tag = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_18, il2cpp_defaults.int32_class))));
...
IL_005b:
	{
		...
		return ((*(bool*)((bool*)(bool*)UnBox(L_25, il2cpp_defaults.boolean_class))));
	}
}
...
IL_002d:
	...
	}
	{
		...
		V_1 = ((*(int64_t*)((int64_t*)(int64_t*)UnBox(L_13, il2cpp_defaults.int64_class))));
		goto IL_009a;
	}
...
IL_00a8:
	...
	}
	{
		...
		V_4 = ((*(float*)((float*)(float*)UnBox(L_27, il2cpp_defaults.single_class))));
		float L_28 = V_4;
		il2cpp_codegen_runtime_class_init_inline(XmlConvert_t5D100AFD62FF717BD4F8A6CABA9EDF7A5DF719EA_il2cpp_TypeInfo_var);
		String_t* L_29;
